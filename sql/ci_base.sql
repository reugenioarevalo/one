...
INSERT INTO `usuarios` (`id`, `ip_address`, `username`, `password`, `email`, `activation_code`, `forgotten_password_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`) VALUES
...
CREATE TABLE `usuarios_grupos` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_usuarios_grupos_usuarios1_idx` (`user_id`),
  KEY `fk_usuarios_grupos_grupos1_idx` (`group_id`),
  CONSTRAINT `uc_usuarios_grupos` UNIQUE (`user_id`, `group_id`),
...
INSERT INTO `usuarios_grupos` (`id`, `user_id`, `group_id`) VALUES
     (1,1,1),
     (2,1,2);
...
#
# Table structure for table 'login_errores'
#
